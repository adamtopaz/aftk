...
from aftk.jsonrpc import JsonRpcErrorResponse
...
from aftk.transport import AsyncJsonRpcSubprocessTransport
...
class AsyncAftkClient:
    ...
    async def get_goals(
        ...
        return await self.request(
            "get_goals",
            FileNodeParams(path=wire_path, id=node_id),
            GetGoalsResult,
            timeout=timeout,
            file_path=wire_path,
        )
    ...
    async def run_tactic(
        ...
        return await self.request(
            "run_tactic",
            RunTacticParams(path=wire_path, id=node_id, tactic=tactic),
            RunTacticResult,
            timeout=timeout,
            file_path=wire_path,
        )
    ...
    async def run_tactic_steps(
        ...
        *,
        ...
        return await self.request(
            "run_tactic_steps",
            RunTacticStepsParams(path=wire_path, id=node_id, tactics=list(tactics)),
            RunTacticStepsResult,
            timeout=timeout,
            file_path=wire_path,
        )
    ...
    async def knowledgebase_rename(
        ...
        *,
        ...
        return await self.request(
            ...
            KnowledgeBaseRenameParams(root=self._wire_optional_path(root), oldId=old_id, newId=new_id),
            KnowledgeBaseRenameResult,
            timeout=timeout,
        )
    ...
    async def informal_decl(
        ...
        return await self.request(
            "informal_decl",
            InformalDeclParams(modules=list(modules), declName=decl_name),
            InformalDeclResult,
            timeout=timeout,
        )
    ...
    async def informal_decl_deps(
        ...
        *,
        ...
        return await self.request(
            "informal_decl_deps",
            InformalDepsParams(modules=list(modules), onlyLeaves=only_leaves),
            InformalDeclDepsResult,
            timeout=timeout,
        )
